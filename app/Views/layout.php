...
<body>
  ...
  <?= $this->include('components/header') ?> <!--UNTUK MEMANGGIL COMPONENT HEADER-->

  <?= $this->include('components/sidebar') ?> <!--UNTUK MEMANGGIL COMPONENT SIDEBAR-->
  ...
  <?= $this->include('components/footer') ?> <!--UNTUK MEMANGGIL COMPONENT FOOTER-->
